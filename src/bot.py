...
START_TEXT = (
    ...
    " маркеры списков на '-', а также убираю артефакты и невидимые маркеры от LLM\n\n"
    "Сохраняю ваши сообщения в наших системах для последующего анализа, направленного на исключительно повышение эффективности и качества предоставляемых услуг."
)
